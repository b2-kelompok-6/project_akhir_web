...
<body>
    ...
    <h1 style="margin-bottom: -80px; margin-top: 70px; margin-left: 795px;"><span style="color: red; margin-left: -40px;">Edit </span>Barang</h1><br>    <form method="POST" action="" style="margin-top: 90px;">
